...
export const chapter43Content: ChapterContent = {
  title: 'Chapter 43',
  introduction: 'This is the introduction for Chapter 43.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 43 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 43?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
