...
export const chapter56Content: ChapterContent = {
  title: 'Chapter 56',
  introduction: 'This is the introduction for Chapter 56.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 56 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 56?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
