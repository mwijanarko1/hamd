...
export const chapter35Content: ChapterContent = {
  title: 'Chapter 35',
  introduction: 'This is the introduction for Chapter 35.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 35 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 35?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
