...
export const chapter45Content: ChapterContent = {
  title: 'Chapter 45',
  introduction: 'This is the introduction for Chapter 45.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 45 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 45?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
