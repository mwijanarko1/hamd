...
export const chapter36Content: ChapterContent = {
  title: 'Chapter 36',
  introduction: 'This is the introduction for Chapter 36.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 36 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 36?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
