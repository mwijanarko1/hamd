...
export const chapter22Content: ChapterContent = {
  title: 'Chapter 22',
  introduction: 'This is the introduction for Chapter 22.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 22 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 22?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
