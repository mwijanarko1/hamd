...
export const chapter54Content: ChapterContent = {
  title: 'Chapter 54',
  introduction: 'This is the introduction for Chapter 54.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 54 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 54?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
