...
export const chapter63Content: ChapterContent = {
  title: 'Chapter 63',
  introduction: 'This is the introduction for Chapter 63.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 63 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 63?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
