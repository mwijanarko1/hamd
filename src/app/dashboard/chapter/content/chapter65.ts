...
export const chapter65Content: ChapterContent = {
  title: 'Chapter 65',
  introduction: 'This is the introduction for Chapter 65.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 65 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 65?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
