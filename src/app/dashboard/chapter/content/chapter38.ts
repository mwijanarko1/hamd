...
export const chapter38Content: ChapterContent = {
  title: 'Chapter 38',
  introduction: 'This is the introduction for Chapter 38.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 38 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 38?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
