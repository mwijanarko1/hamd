...
export const chapter58Content: ChapterContent = {
  title: 'Chapter 58',
  introduction: 'This is the introduction for Chapter 58.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 58 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 58?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
