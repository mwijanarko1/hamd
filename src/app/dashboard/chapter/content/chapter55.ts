...
export const chapter55Content: ChapterContent = {
  title: 'Chapter 55',
  introduction: 'This is the introduction for Chapter 55.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 55 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 55?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
