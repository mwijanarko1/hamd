...
export const chapter33Content: ChapterContent = {
  title: 'Chapter 33',
  introduction: 'This is the introduction for Chapter 33.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 33 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 33?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
