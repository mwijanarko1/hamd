...
export const chapter50Content: ChapterContent = {
  title: 'Chapter 50',
  introduction: 'This is the introduction for Chapter 50.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 50 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 50?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
