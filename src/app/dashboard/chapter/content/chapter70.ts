...
export const chapter70Content: ChapterContent = {
  title: 'Chapter 70',
  introduction: 'This is the introduction for Chapter 70.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 70 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 70?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
