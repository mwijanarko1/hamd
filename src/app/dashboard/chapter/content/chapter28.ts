...
export const chapter28Content: ChapterContent = {
  title: 'Chapter 28',
  introduction: 'This is the introduction for Chapter 28.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 28 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 28?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
