...
export const chapter29Content: ChapterContent = {
  title: 'Chapter 29',
  introduction: 'This is the introduction for Chapter 29.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 29 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 29?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
