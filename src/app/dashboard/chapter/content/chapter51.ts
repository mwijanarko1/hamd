...
export const chapter51Content: ChapterContent = {
  title: 'Chapter 51',
  introduction: 'This is the introduction for Chapter 51.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 51 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 51?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
