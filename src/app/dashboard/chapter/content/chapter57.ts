...
export const chapter57Content: ChapterContent = {
  title: 'Chapter 57',
  introduction: 'This is the introduction for Chapter 57.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 57 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 57?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
