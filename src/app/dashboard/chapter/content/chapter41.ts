...
export const chapter41Content: ChapterContent = {
  title: 'Chapter 41',
  introduction: 'This is the introduction for Chapter 41.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 41 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 41?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
