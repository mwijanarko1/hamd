...
export const chapter47Content: ChapterContent = {
  title: 'Chapter 47',
  introduction: 'This is the introduction for Chapter 47.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 47 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 47?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
