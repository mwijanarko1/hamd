...
export const chapter48Content: ChapterContent = {
  title: 'Chapter 48',
  introduction: 'This is the introduction for Chapter 48.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 48 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 48?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
