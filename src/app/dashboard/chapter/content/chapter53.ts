...
export const chapter53Content: ChapterContent = {
  title: 'Chapter 53',
  introduction: 'This is the introduction for Chapter 53.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 53 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 53?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
