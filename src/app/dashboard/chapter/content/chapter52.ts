...
export const chapter52Content: ChapterContent = {
  title: 'Chapter 52',
  introduction: 'This is the introduction for Chapter 52.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 52 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 52?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
