...
export const chapter67Content: ChapterContent = {
  title: 'Chapter 67',
  introduction: 'This is the introduction for Chapter 67.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 67 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 67?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
