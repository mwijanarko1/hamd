...
export const chapter24Content: ChapterContent = {
  title: 'Chapter 24',
  introduction: 'This is the introduction for Chapter 24.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 24 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 24?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
