...
export const chapter60Content: ChapterContent = {
  title: 'Chapter 60',
  introduction: 'This is the introduction for Chapter 60.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 60 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 60?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
