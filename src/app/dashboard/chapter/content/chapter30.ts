...
export const chapter30Content: ChapterContent = {
  title: 'Chapter 30',
  introduction: 'This is the introduction for Chapter 30.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 30 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 30?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
