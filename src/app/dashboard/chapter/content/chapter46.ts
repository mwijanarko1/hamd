...
export const chapter46Content: ChapterContent = {
  title: 'Chapter 46',
  introduction: 'This is the introduction for Chapter 46.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 46 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 46?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
