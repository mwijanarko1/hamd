...
export const chapter59Content: ChapterContent = {
  title: 'Chapter 59',
  introduction: 'This is the introduction for Chapter 59.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 59 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 59?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
