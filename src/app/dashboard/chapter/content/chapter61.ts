...
export const chapter61Content: ChapterContent = {
  title: 'Chapter 61',
  introduction: 'This is the introduction for Chapter 61.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 61 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 61?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
