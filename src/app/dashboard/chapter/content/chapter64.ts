...
export const chapter64Content: ChapterContent = {
  title: 'Chapter 64',
  introduction: 'This is the introduction for Chapter 64.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 64 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 64?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
