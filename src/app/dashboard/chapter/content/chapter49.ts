...
export const chapter49Content: ChapterContent = {
  title: 'Chapter 49',
  introduction: 'This is the introduction for Chapter 49.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 49 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 49?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
