...
export const chapter69Content: ChapterContent = {
  title: 'Chapter 69',
  introduction: 'This is the introduction for Chapter 69.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 69 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 69?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
