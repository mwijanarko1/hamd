...
export const chapter31Content: ChapterContent = {
  title: 'Chapter 31',
  introduction: 'This is the introduction for Chapter 31.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 31 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 31?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
