...
export const chapter39Content: ChapterContent = {
  title: 'Chapter 39',
  introduction: 'This is the introduction for Chapter 39.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 39 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 39?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
