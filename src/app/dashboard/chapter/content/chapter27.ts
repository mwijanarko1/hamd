...
export const chapter27Content: ChapterContent = {
  title: 'Chapter 27',
  introduction: 'This is the introduction for Chapter 27.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 27 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 27?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
