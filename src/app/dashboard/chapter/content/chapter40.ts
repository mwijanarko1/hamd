...
export const chapter40Content: ChapterContent = {
  title: 'Chapter 40',
  introduction: 'This is the introduction for Chapter 40.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 40 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 40?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
