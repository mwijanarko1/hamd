...
export const chapter32Content: ChapterContent = {
  title: 'Chapter 32',
  introduction: 'This is the introduction for Chapter 32.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 32 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 32?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
