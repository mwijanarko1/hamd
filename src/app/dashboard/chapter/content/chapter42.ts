...
export const chapter42Content: ChapterContent = {
  title: 'Chapter 42',
  introduction: 'This is the introduction for Chapter 42.',
  mainCategories: [
  ...
  quiz: {
    title: 'Chapter 42 Quiz',
    questions: [
      {
        difficulty: 'Easy',
        question: 'Sample question for Chapter 42?',
        options: {
          a: 'Option A',
          b: 'Option B',
          c: 'Option C',
